    ...
    <div className='min-h-screen flex flex-col'>
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground">Desenvolvido por Igor de Paula</span>
      ...
      <main className='flex-1 p-6 flex gap-6'>
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <p className='tetx-sm text-muted-foreground'>Lembre-se: você pode utilizar a variável <code className='text-orange-500'>{'{transcription}'}</code> no seu prompt para adicionar o conteúdo da transcrição do vídeo selecionado</p>
        </div>
          ...
          <form className='space-y-6'>
            <div className='space-y-2'>
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectItem value='1'>Título da Aula</SelectItem>
                  <SelectItem value='2'>Descrição da Aula</SelectItem>
                </SelectContent>
              </Select>
            </div>
